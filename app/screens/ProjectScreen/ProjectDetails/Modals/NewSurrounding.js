...
const Surrounding = (props) => {
  ...
  console.log("55 datas: ", datas);
  console.log("56 setDataFilter: ", setDataFilter); //untuk memfilter amenities type aja dan jgn ada yang sama
                        ...
                        {itemType === item.amenities_type ? (
                          <>
                            ...
                            <Image
                              ...
                              source={{
                                uri: item.amenities_url,
                              }}
                            />
                            <RenderHtml
                              contentWidth={widthRender}
                              source={{
                                html: `<div style="margin-right: 20px;text-indent: 20px;">
                                                                      ${item.amenities_info}
                                                                    </div>`,
                              }}
