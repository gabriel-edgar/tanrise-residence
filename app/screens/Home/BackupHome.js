...
const Home = props => {
  ...
  useEffect(() => {
    dispatch(
      apiCall(
        `http://apps.pakubuwono-residence.com/apiwebpbi/api/notification?email=${email}&entity_cd=01&project_no=01`,
      ),
    );
  }, []);
  ...
  async function fetchDataDue() {
    try {
      const res = await axios.get(
        `http://apps.pakubuwono-residence.com/apiwebpbi/api/getDataDueSummary/IFCAPB/${user.user}`,
      );
  ...
  async function fetchDataNotDue() {
    try {
      const res = await axios.get(
        `http://apps.pakubuwono-residence.com/apiwebpbi/api/getDataCurrentSummary/IFCAPB/${user.user}`,
      );
  ...
  async function fetchDataHistory() {
    try {
      const res = await axios.get(
        `http://apps.pakubuwono-residence.com/apiwebpbi/api/getSummaryHistory/IFCAPB/${user.user}`,
      );
