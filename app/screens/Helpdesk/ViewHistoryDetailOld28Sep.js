            ...
            {tab.id == 1 && (
              <ScrollView>
                <View style={{ margin: 5, paddingRight: 10 }}>
                  ...
                  {
                    //Need Approve : (SRF Approved, Before WO, After WO)
                    // need approval, normal = dataTiketMulti.status == "R" ? null : (
...

                  {
                    ...
                    dataTiketMulti.status == "P" &&
                    dataTiketMulti.status_approval == null ? ( //dikasih kondisi null karena belum tau kapan diapprove
                      // dataTiketMulti.before_chief != null //ini tidak ada di table header
...

                  {
                    ...
                    dataTiketMulti.status == "F" &&
                    dataTiketMulti.status_approval == null ? ( //dikasih kondisi null karena belum tau kapan diapprove
                      // dataTiketMulti.after_chief != null // tidak
                      <View style={{ marginTop: 10 }}>
                        <Button
                          style={{
                            height: 40,
                      ...
                      <TouchableOpacity
                        ...
                        onPress={() =>
                          navigation.navigate("PreviewImageHelpdesk", {
                            images: [{ file_url: dataTiketMulti.link_url }],
                          })
                        }
                      >
                        <Image
