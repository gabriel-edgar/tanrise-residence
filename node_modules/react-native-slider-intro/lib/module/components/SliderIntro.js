...
const defaultProps = {
  ...
  renderStatusBar: backgroundColor => /*#__PURE__*/React.createElement(StatusBarContainer, {
    backgroundColor: backgroundColor
  })
};
export function SliderIntro({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, showStatusBar && renderStatusBar(statusBarColor), /*#__PURE__*/React.createElement(Animated.View, _extends({
