...
export interface IPrevContainer {
    ...
    type: 'previous' | 'skip';
    goToNewSlide: (nextActive: number, slide: ISlide, setSlide: (arg0: ISlide) => void, numberOfSlide: number, onDone: () => void, navContainerMaxSize: number, dotWidth: number, deviceMaxWidth: number) => void;
    slide: ISlide;
